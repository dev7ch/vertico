...
class BoxBlock extends PhpBlock
{
    ...
    public function config()
    {
        return [
            'vars' => [
                 ...
                 ['var' => 'link', 'label' => 'Link', 'type' => self::TYPE_LINK], /** remove this line if you use linkinjectors() */
            ],
        ];
    }

    /**
     * LinkInjectors as a more smart way to handle links.
     *
     ...
     *  }
     *
     * If you dive deeper into the LUYA CMS this is the recommended way to handle links in blocks.
     *
     * - you don´t need to specify a vars variable
     * - you don´t need to write a getLinkTarget() function
     * - you don´t need to specify a extrasVars variable
     *
     * An extraVars value will be generated by the linkInjectors() automatically wich are available in your view file as following:
     *
     * <?= $this->extraValue('link'); ?>
     *
     */

    public function getLinkTarget() /** remove this function if you use linkinjectors() */
    {
    ...
    {
        return [
            'link' => $this->getLinkTarget(), /** remove this line if you use linkinjectors() */
